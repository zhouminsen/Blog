package org.java.base.exception.interceptor;
...
import org.java.base.system.WebStatusConstant;
...
public class CustomExceptionResolver implements HandlerExceptionResolver {
	...
	public ModelAndView resolveException(HttpServletRequest request,
		...
		response.setStatus(Integer.parseInt(WebStatusConstant.INTERNAL_SERVER_ERROR));
		try {
