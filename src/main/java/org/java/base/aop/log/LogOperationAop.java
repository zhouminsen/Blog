...
import org.java.base.system.initialize.InitComponent;
...
public class LogOperationAop{
	 ...
	 * @param joinPoint
	 */
	@Before("execution(* org.java..service.*.*(..))")
...
//		System.out.println("******参数" + list + "******");
	 ...
	 * @param joinPoint
	 */
	@After("execution(* org.java..service.*.*(..))")
...
//		System.out.println(rightnow + "执行了【" + object + "方法结束......】");
	 ...
	 * @param result 
	 */
	@AfterReturning(value = "execution(* org.java..service.*.modify*(..)) "
			+ "|| execution(* org.java..service.*.delete*(..)) "
			+ "|| execution(* org.java..service.*.save*(..))"
			+ "|| execution(* org.java..service.*.backup*(..))", returning = "result")
	public void afterReturn(JoinPoint joinPoint, Object result) {
		...
		try {
			...
			//得到参数列表
			logOperation.setParameter(JsonUtil.parseToJson(joinPoint.getArgs()));
			//得到sql
